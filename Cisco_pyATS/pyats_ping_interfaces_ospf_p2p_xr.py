...
print("\nPING ALL P2P WAN LINK INTERFACE - XR")
print("====================================")
...
for rtr in rtr_list: 
	...
	p1 = dev.parse('show ospf vrf all-inclusive interface')
	...
	dev.execute("show ospf interface brief")
	...
	for ipdestination in IP_DEST:
		dev.execute('ping ' + ipdestination + ' repeat 100 type 192', timeout=450)
